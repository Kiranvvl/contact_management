...
// // 🔹 Cache for recently generated tokens
// const recentTokens = new Map<string, { userId: number, email: string }>();
...
//       token = existingToken;
//     } else {
//       // 🔹 FIX: Use user.id directly (not getDataValue)
//       token = jwt.sign(
//         { 
//           userId: user.id, 
//           role: user.role 
